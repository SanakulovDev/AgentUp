export function buildTemplateContext(answers) {
    return {
...
export function renderAgentUpManifest(answers) {
    return {
...
export function renderAgentsMd(ctx) {
    const dbText = ctx.database && ctx.database !== 'none'
...
export function renderClaudeRoot() {
    return `# CLAUDE.md
...
export function renderClaudeSettings(answers) {
    return {
...
export function renderClaudeSettingsLocalExample() {
    return {
        allowedTools: ['Read', 'Edit', 'Write', 'Glob', 'Grep', 'LS', 'Bash'],
        dangerousMode: true,
...
export function renderClaudeVerificationRule(ctx) {
    return `---
files: ["**/*"]
---
...
export function renderClaudeOutputRule() {
    return `---
files: ["**/*"]
---
...
export function renderClaudeCommand(role, ctx) {
    const roleText = {
...
export function renderClaudeSkill(role, ctx) {
    return `---
name: ${role}-workflow
...
- Framework: ${ctx.framework ?? 'not specified'}
- Docker: ${ctx.dockerEnabled ? 'yes' : 'no'}
- Database: ${ctx.database && ctx.database !== 'none'
        ? `${ctx.database} ${ctx.databaseVersion ?? ''}`.trim()
        : 'none'}
...
export function renderClaudeAgent(role, ctx) {
    return `---
...
export function renderClaudeHooksReadme(ctx) {
    return `# Claude hooks
...
export function renderCursorReadme(ctx) {
    return `# .cursor
...
export function renderCursorCommand(role, ctx) {
    return `# /${role}
...
export function renderCursorSkill(role, ctx) {
...
export function renderCursorAgent(role, ctx) {
...
export function renderCursorArchitectureDoc(ctx) {
...
export function renderCursorHooksReadme(ctx) {
    return `# Cursor hooks
...
export function renderRoleObjective(role, ctx) {
    switch (role) {
        case 'plan':
...
export function renderCommandList(commands) {
    const entries = [];
    if (commands.dev)
        entries.push(`- Dev: \`${commands.dev}\``);
    if (commands.build)
        entries.push(`- Build: \`${commands.build}\``);
    if (commands.test)
        entries.push(`- Test: \`${commands.test}\``);
    if (commands.lint)
        entries.push(`- Lint: \`${commands.lint}\``);
